            ...
            do {
                ...
                switch (opcion) {
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                        int k = Integer.parseInt(JOptionPane.showInputDialog("Introduce o correo que desexe amosar"));
                        buzon.amosar(k);
                        break;
                    case "5":
                        buzon.mostrar();
                        break;
                    case "6":
                        int n = Integer.parseInt(JOptionPane.showInputDialog("Introduce o correo que desexe eliminar"));
                        buzon.eliminar(n);
                        break;
                    case "7":
